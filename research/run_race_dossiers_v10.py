#!/usr/bin/env python3
"""以前台单线程低资源模式生成 Race Dossier v10。"""
...
DEFAULT_CONFIG = (
    ROOT / "research" / "configs" / "race_dossier_2023_2025_v10.json"
)
...
def main() -> int:
    ...
    if config.get("method_version") != "v10":
        parser.error("v10 runner 只接受 method_version=v10")
    result = engine.run(
        config,
        run_id=args.run_id,
