#!/usr/bin/env python3
"""以前台单线程低资源模式生成 Race Dossier v13。"""
...
DEFAULT_CONFIG = (
    ROOT / "research" / "configs" / "race_dossier_2023_2025_v13.json"
)
...
def main() -> int:
    ...
    if config.get("method_version") != "v13":
        parser.error("v13 runner 只接受 method_version=v13")
    result = engine.run(
        config,
        run_id=args.run_id,
